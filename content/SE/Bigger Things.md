...
## Data Path
{{< figure "Data Path" "/images/SE1.datapath0.png" right 20 >}}
...
{{< figure "Multiplexer" "/images/SE1.2-1-mux.png" right 20 >}}
...
{{< figure "Boolean Logic (1st try)" "/images/SE1.ALU0.png" right 30 >}}
...
{{< figure "Boolean Logic" "/images/SE1.ALU1.png" right 30 >}}
...
{{< figure "Add/Subtract Integers" "/images/SE1.AU.png" right 50 >}}
...
{{< figure "Logical Shift Right" "/images/SE1.LSR.png" right 50 >}}

* LSR: Logical shift right, copying the rightmost bit into the carry (to be tested and used).  

* {{< figure "Logical Shift Left" "/images/SE1.LSL.png" left 30 >}}LSL: Logical shift left (also ASL). This is times 2 for unsigned numbers.
* {{< figure "Arithmetic Shift Right" "/images/SE1.ASR.png" right 30 >}} Arithmetic shift right keeping the sign-bit in place so that divide by 2 is valid (rounds down towards negative infinity).
* {{< figure "Rotate Left" "/images/SE1.ROL.png" left 30 >}} Rotate left.  
<br>
<br>
* {{< figure "Rotate Right" "/images/SE1.RORC.png" right 30 >}} Rotate right through carry.

### Barrel Shifter

{{< figure "Barrel Shifter" "/images/SE1.barrel.png" right 40 >}}
...
{{< figure "ALU Symbol" "/images/SE1.ALUsymbol.png" right 20 >}}

We've now seen all major components in an ALU and we've seen the mechanisms to join them into one large component (of less than one millionth of a millimetre squared).
...
* We've show a barrel shifter offering ROL. A barrel shifter which performs ROL, LSL, ROR, LSR and ASR is an extension of what we have already seen.
