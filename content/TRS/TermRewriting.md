...
There are a few more Zermelo Fraenkel axioms, which are relevant for inifinite sets and which are of no concern to us.
...
# Notation
So far, we used this notation `l → r` for rules.
