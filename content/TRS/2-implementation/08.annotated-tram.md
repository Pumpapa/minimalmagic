...
```
## Garbage Collection
Memory Management is discussed in [Section Memory Management](https://minimal-magic.online/trs/memorymanagement/).
```C
int gen=0;  
void gc() {  
...
```
## Scanner / Parser 
Scanner / Parser discussed in [Section Converting from C to Tram (Scanner/Parser)](https://minimal-magic.online/trs/convertingctotram/)
```C
FILE *in;  
int c;  
...
```
# Rewrite Engine
Discussed in [Section Converting Rewrite Engine from Tram to C](https://minimal-magic.online/trs/convertingtramtoc/)
```C
